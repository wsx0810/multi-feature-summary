...
def _split_into_words(sentences):
    ...
    for sentence in sentences:
        sentences_list += re.split('[，。？！：；“” （）【】]',sentence)
        
   
    return list(itertools.chain(*sentences_list))
...
#    print(evaluated_count, reference_count)
...
def rouge(hypotheses, references):
    ...
    return {
        ...
        "f_mean":np.mean([rouge_1_f,rouge_2_f,rouge_l_f])
    }
